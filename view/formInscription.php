<div class="row mt-5 mb-5">
  <div class="col-md-12">
    ...
    <form action="./?action=traitement-inscription&choix=1" method="POST">
      <fieldset>
      ...
      <fieldset>
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              <input type="text" id="name" name="adher_nom" class="form-control" placeholder="Nom" required>
            </div>

            <div class="col-md-6">
              <input type="text" id="name" name="adher_prenom" class="form-control" placeholder="Prénom" required>
            </div>

            <div class="col-md-6">
              <input type="email" id="email" name="adher_email" class="form-control" placeholder="E-mail" required>
            </div>

            <div class="col-md-6">
              <input type="text" id="tel" name="adher_tel" class="form-control" placeholder="Téléphone" required>
            </div>
